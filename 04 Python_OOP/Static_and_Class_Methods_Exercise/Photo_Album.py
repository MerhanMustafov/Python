class PhotoAlbum:
    ...
    def add_photo(self, label: str):
        # if len(self.photos) >= self.pages-1 and PhotoAlbum.slot == 4:
        ...
        result = f"{label} photo added successfully on page {self.page+1} slot {self.slot}"
        self.slot += 1
        return result
...
# print(album.add_photo("party with"))
# print(album.photos)
